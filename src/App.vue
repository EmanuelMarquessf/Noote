          ...
          >
            <template #item="{ element }" >
              <div class="relative group">
                <img class="rounded max-h-72 w-full h-full object-cover" :src="element" alt="" />
                <v-icon
                  class="text-accent/80 cursor-pointer w-6 h-6 transition-opacity ease-linear duration-100 opacity-0 group-hover:opacity-100 absolute top-0 right-0 m-2"
                  name="bi-trash-fill"
